            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ asset('our-terms-conditions/create') }}" class="btn btn-primary" style="float:right;"><i
                                class="fa fa-plus"></i> Add New Term</a>
                    </div>
                    <!-- /.card-header -->
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @forelse ($data as $value)
                                      <tr>
                                        ...
                                        <td>
                                          <a href="{{ asset('our-terms-conditions') }}/{{ $value->id }}/edit"><button
                                                  type="button" class="btn btn-warning">Edit</button></a>
                                          <a onclick="return confirm('Are you sure you want to delete?')"
                                              href="{{ asset('our-terms-conditions') }}/destroy/{{ $value->id }}"><button

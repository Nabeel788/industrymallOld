...
<head>
    ...
    <meta name="author" content="Industry Mall">
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            ...
            <div class="container-fluid">
                                                                ...
                                                                <div class="product text-center">
                                                                    <figure class="product-media">
                                                                        <a
                                                                            ...
                                                                            @else
                                                                                <img src="{{ URL::asset('root/upload/store-products/dummy-bg-img.png') }}"
                                                                                    alt="Product" />
                                                                            @endif
                                                                        </a>
                                                                        <hr>
                        ...
                        <div class="tab tab-nav-boxed tab-nav-outline appear-animate">
                            <ul class="nav nav-tabs justify-content-left" style="float: left;margin-top:45px;"
                                ...
                                @foreach ($SubcategoriesList2 as $value)
                                    @if ($tab2 == 0)
                                        <li class="nav-item mr-2 mb-2">
                                            <a class="nav-link active br-sm font-size-md ls-normal" title="{{ $value->name }}"
                                                href="#tab2-{{ $tab2 }}">{{ substr($value->name, 0, 21) }}...</a>
                                        </li>
                                    @else
                                        <li class="nav-item mr-2 mb-2">
                                    ...
                                    @php $tab2++; @endphp
                                @endforeach
                                {{-- <li class="nav-item mr-2 mb-2 mt-2"><a href="{{ URL::to('/shop/cat/'.$homeSettings->category2) }}" class="font-size-normal font-weight-bold ls-25 mb-0">More
                                    Products <i class="w-icon-long-arrow-right" style="position: relative;top:2px;"></i></a></li> --}}
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-1 col-md-1 col-sm-1 appear-animate" style="margin-top:55px;padding-right:10px;padding-left:1px;text-align:right">
                        <a href="{{ URL::to('/shop/cat/'.$homeSettings->category2) }}" class="font-size-normal font-weight-bold ls-25 mb-8">More
                            Products <i class="w-icon-long-arrow-right" style="position: relative;top:2px;align-items:right;"></i></a>
                    </div>
                </div>
                <!-- End of Tab -->
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <h2 class="title text-left ls-normal mt-10 pt-1 appear-animate" title="@if($category3){{ $category3->name }}@endif">@if($category3){{ substr($category3->name,0,57) }}...@endif</h2>
                        {{-- <hr class="banner-divider bg-dark mb-2" style="margin-top: -10px;"> --}}
                    </div>
                    <div class="col-lg-8 col-md-8 col-sm-10">
                        <div class="tab tab-nav-boxed tab-nav-outline appear-animate">
                            <ul class="nav nav-tabs justify-content-left" style="float: left;margin-top:45px;"
                                ...
                                @foreach ($SubcategoriesList3 as $value)
                                    @if ($tab3 == 0)
                                        <li class="nav-item mr-2 mb-2">
                                            <a class="nav-link active br-sm font-size-md ls-normal" title="{{ $value->name }}"
                                                href="#tab3-{{ $tab3 }}">{{ substr($value->name, 0, 21) }}...</a>
                                        </li>
                                    @else
                                        <li class="nav-item mr-2 mb-2">
                                            <a class="nav-link br-sm font-size-md ls-normal" title="{{ $value->name }}"
                                    ...
                                    @php $tab3++; @endphp
                                @endforeach
                                {{-- <li class="nav-item mr-2 mb-2 mt-2"><a href="{{ URL::to('/shop/cat/'.$homeSettings->category3) }}" class="font-size-normal font-weight-bold ls-25 mb-0">More
                                    Products <i class="w-icon-long-arrow-right" style="position: relative;top:2px;"></i></a></li> --}}
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-1 col-md-1 col-sm-1 appear-animate" style="margin-top:55px;padding-right:10px;padding-left:1px;text-align:right">
                        <a href="{{ URL::to('/shop/cat/'.$homeSettings->category3) }}" class="font-size-normal font-weight-bold ls-25 mb-8">More
                            Products <i class="w-icon-long-arrow-right" style="position: relative;top:2px;align-items:right;"></i></a>
                    </div>
                </div>
                <!-- End of Tab -->
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12">
                        <h2 class="title text-left ls-normal mt-10 pt-1 appear-animate" title="@if($category4){{ $category4->name }}@endif">@if($category4){{ substr($category4->name,0,57) }}...@endif</h2>
                        {{-- <hr class="banner-divider bg-dark mb-2" style="margin-top: -10px;"> --}}
                    </div>
                    <div class="col-lg-8 col-md-8 col-sm-10">
                        <div class="tab tab-nav-boxed tab-nav-outline appear-animate">
                            <ul class="nav nav-tabs justify-content-left" style="float: left;margin-top:45px;"
                                ...
                                @foreach ($SubcategoriesList4 as $value)
                                    @if ($tab4 == 0)
                                        <li class="nav-item mr-2 mb-2">
                                            <a class="nav-link active br-sm font-size-md ls-normal" title="{{ $value->name }}"
                                                href="#tab4-{{ $tab4 }}">{{ substr($value->name, 0, 21) }}...</a>
                                        </li>
                                    @else
                                        <li class="nav-item mr-2 mb-2">
                                            <a class="nav-link br-sm font-size-md ls-normal" title="{{ $value->name }}"
                                    ...
                                    @php $tab4++; @endphp
                                @endforeach
                                {{-- <li class="nav-item mr-2 mb-2 mt-2"><a href="{{ URL::to('/shop/cat/'.$homeSettings->category4) }}" class="font-size-normal font-weight-bold ls-25 mb-0">More
                                    Products <i class="w-icon-long-arrow-right" style="position: relative;top:2px;"></i></a></li> --}}
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-1 col-md-1 col-sm-1 appear-animate" style="margin-top:55px;padding-right:10px;padding-left:1px;text-align:right">
                        <a href="{{ URL::to('/shop/cat/'.$homeSettings->category4) }}" class="font-size-normal font-weight-bold ls-25 mb-8">More
                            Products <i class="w-icon-long-arrow-right" style="position: relative;top:2px;align-items:right;"></i></a>
                    </div>
                </div>
                <!-- End of Tab -->
                                                                        ...
                                                                        <div class="row" style="">
                                                                            <div class="col-8 text-left"
                                                                                ...
                                                                                <div style="margin-top:-10px;">
                                                                                    ...
                                                                                    <div>
                                                                                        &emsp;&nbsp;<img
                                                                                            src="{{ URL::asset($value->brand->logo) }}"
                                                                                            style="width: 50px;margin-top:-15px;margin-bottom:40px;"
                                                                                            alt="">
                                                                                    </div>
                                                                                </div>

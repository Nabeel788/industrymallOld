...
<!-- Mirrored from portotheme.com/html/wolmart/product-gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Jul 2022 05:55:01 GMT -->
<head>
    <meta charset="UTF-8">
...
<body>
                        ...
                        <div class="main-content">
                            <div class="product product-single mb-4">
                                        ...
                                        <div class="swiper-wrapper row cols-sm-2">
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="assets/images/products/gallery/1-800x900.jpg"
                                                        data-zoom-image="assets/images/products/gallery/1-800x900.jpg"
                                                        alt="Smart Watch" width="800" height="900">
                                            ...
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="assets/images/products/gallery/2-800x900.jpg"
                                                        data-zoom-image="assets/images/products/gallery/2-800x900.jpg"
                                                        alt="Smart Watch" width="488" height="549">
                                                    <a href="#" class="product-gallery-btn product-image-full"><i
                                                            class="w-icon-zoom"></i></a>
                                                </figure>
                                            </div>
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="assets/images/products/gallery/3-800x900.jpg"
                                                        data-zoom-image="assets/images/products/gallery/3-800x900.jpg"
                                                        alt="Smart Watch" width="800" height="900">
                                                    <a href="#" class="product-gallery-btn product-image-full"><i
                                                            class="w-icon-zoom"></i></a>
                                                </figure>
                                            ...
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="assets/images/products/gallery/4-800x900.jpg"
                                                        data-zoom-image="assets/images/products/gallery/4-800x900.jpg"
                                                        alt="Smart Watch" width="800" height="900">
                                                    <a href="#" class="product-gallery-btn product-image-full"><i
                                                            class="w-icon-zoom"></i></a>
                                                </figure>
                                ...
                                <div class="product-details row pl-0">
                                    <div class="col-md-6">
                                        <h1 class="product-title">Smart Watch</h1>
                                        <div class="product-bm-wrapper">
                                            ...
                                            <div class="product-meta">
                                                <div class="product-categories">
                                                    Category:
                                                    <span class="product-category"><a href="#">Watches</a></span>
                                                </div>
                                        ...
                                        <div class="product-price">
                                            <ins class="new-price">$80.00 - $90.00</ins></div>
                                    ...
                                    <div class="col-md-6">
                                        <div
                                            class="product-form product-variation-form product-color-swatch product-variations mt-1">
                                            <label>Color:</label>
    ...
    <!-- Start of Scroll Top -->
    {{-- <a id="scroll-top" class="scroll-top" href="#top" title="Top" role="button"> <i class="fas fa-arrow-up" style="color: white"></i> <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 70 70"> <circle id="progress-indicator" fill="transparent" stroke="#000000" stroke-miterlimit="10" cx="35" cy="35" r="34" style="stroke-dasharray: 16.4198, 400;"></circle> </svg> </a> --}}
    <a id="scroll-top" class="scroll-top" href="#top" title="Top" role="button">
        <!-- Circle -->
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 70 70">
            <circle id="progress-indicator" fill="white" stroke="#000000" stroke-miterlimit="10" cx="35" cy="35" r="34" style="stroke-dasharray: 16.4198, 400;"></circle>
        </svg>
        <!-- Arrow -->
        <i class="fas fa-arrow-up" style="color: black; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);"></i>
    </a>
    <!-- End of Scroll Top -->
...
<!-- Mirrored from portotheme.com/html/wolmart/product-gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Jul 2022 05:55:12 GMT -->
</html>
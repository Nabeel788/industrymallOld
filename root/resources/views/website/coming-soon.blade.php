...
<body>
        ...
        <main class="main">
            <div class="page-content">
                <div class="banner coming-soon-bg"
                    style="background-image: url({{ URL::asset('website-assets/images/pages/coming/coming-soon.html') }}); background-color: #333;">
                    <div class="coming-content-wrapper d-flex align-items-center justify-content-end pl-sm-4 pr-sm-4">
                        <div class="coming-content">
                            <a href="demo1.html" class="logo">
                                <img src="{{ URL::asset('website-assets/images/pages/coming/logo.png') }}" alt="Logo" width="168" height="53">
                            </a>
                            ...
                            <p class="copyright mb-0">Copyright © 2021 {{ $settings->title }}. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <a id="scroll-top" class="scroll-top" href="#top" title="Top" role="button"> <i class="fa fa-angle-up"></i> <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 70 70"> <circle id="progress-indicator" fill="transparent" stroke="#000000" stroke-miterlimit="10" cx="35" cy="35" r="34" style="stroke-dasharray: 16.4198, 400;"></circle> </svg> </a>

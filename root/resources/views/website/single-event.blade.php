...
<head>
    ...
    <title>{{ Str::ucfirst($SingleEvent->title) }}</title>
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
            ...
            <div class="page-header">
                <div class="container">
                    <h1 class="page-title mb-0">Single Event</h1>
                </div>
            </div>
            <!-- End of Page Header -->
                        ...
                        <div class="main-content post-single-content">
                            <div class="post post-grid post-single">
                                <figure class="post-media br-sm">
                                    <img src="{{ URL::asset('root/upload/events/big/'.$SingleEvent->image) }}" alt="{{ $SingleEvent->title }} Blog Image" width="930" height="500" />
                                </figure>
                                <div class="post-details">
                                    <div class="post-meta">
                                        by <a href="#" class="post-author">{{ $SingleEvent->created_by_user->name }}</a>
                                        - <a href="#" class="post-date">{{ date('d-m-Y',strtotime($SingleEvent->created_at)) }}</a>
                                        {{-- <a href="#" class="post-comment"><i class="w-icon-comments"></i><span>0</span>Comments</a> --}}
                                    </div>
                                    <h2 class="post-title"><a href="#">{{ $SingleEvent->title }}</a></h2>

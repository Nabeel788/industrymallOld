                            ...
                            <div class="product-details">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 text-right">
                                        ...
                                        <a href="{{ URL::to('/vendor-products/'.$product->biller->name) }}"><img src="{{ URL::asset('root/upload/logo/'.$product->biller->image) }}" style="width: 80px;margin-top: -20px;" alt=""></a>
                                        @else
                                        <img src="{{ URL::asset('root/upload/logo/Industry Mall Logo-01.png') }}" style="width: 80px;margin-top: -20px;" alt="">
                                        @endif
                                            ...
                                            <div class="product-qty-form with-label">
                                                ...
                                                <div class="input-group">
                                                    <input class="quantity form-control" type="number"
                                                        ...
                                                        value="1">
                                                    @if($totalStock<=0)
                                                    <button type="button" class="quantity-plus w-icon-plus" disabled></button>
                                                    <button type="button"

            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ asset('our-faq1/create') }}" class="btn btn-primary" style="float:right;"><i
                                ...
                                <tbody>
                                    ...
                                    @forelse ($data as $value)
                                      <tr>
                                        ...
                                        <td>{!! $value->answer !!}</td>
                                        <td>{{ $value->faq_category->title }}</td>
                                        <td>
                                          <a href="{{ asset('our-faq1') }}/{{ $value->id }}/edit"><button
                                                  type="button" class="btn btn-warning">Edit</button></a>
                                          <a onclick="return confirm('Are you sure you want to delete?')"
                                              href="{{ asset('our-faq1') }}/destroy/{{ $value->id }}"><button

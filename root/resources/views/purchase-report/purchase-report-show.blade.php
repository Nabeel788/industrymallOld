        ...
        <div class="card">
          <div class="card-body">
            <div class="e-profile">
              ...
              <h3 style="text-align: center;"><u>Purchase Report</u></h3>
              <div class="col-md-12">
                           ...
                           @foreach($purchase as $purchases)
                                <tr style="border:2px solid black">
                                  <td>
                                    ...
                                    <td>
                                      {{$purchases->accounts->account_name}}
                                    </td>
                                    <td>
                              ...
                              @php $Totalquantity = $Totalquantity + $detail-> quantity; @endphp
                              @php $Totalcost = $Totalcost + $detail->total; @endphp
                              @endforeach
                                 <td>
                                     {{$Totalquantity}}
                                    </td>

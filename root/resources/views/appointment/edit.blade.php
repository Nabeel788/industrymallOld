          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
               ...
               {!! Form::model($edit, ['method' => 'PATCH', 'action' => ['App\Http\Controllers\AppointmentController@update', $edit->id], 'class' => 'form-horizontal', 'files' => 'true', 'enctype' => 'multipart/form-data' ]) !!}
                <div class="card-body">
                   ...
                   <div class="row">
                    <div class="col-sm-12">
                      <!-- text input -->
                        ...
                        {!! Form::hidden('updated_by', Auth::User()->id, ['id' => 'updated_by','class'=>'form-control', 'placeholder'=>'updated_by']) !!}

            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card card-primary">
                        ...
                        {!! Form::model($edit, ['method' => 'PATCH', 'action' => ['App\Http\Controllers\BlogsController@update', $edit->id], 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('blog_category_id',$blogsCategories ,null, ['id' => 'blog_category_id', 'class' => 'form-control fstdropdown-select']) !!}

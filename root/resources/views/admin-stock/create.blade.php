          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><b>Admin Stock</b></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
            
             
              {!! Form::open(['url' => 'admin-stock', 'method' => 'POST', 'class'=>'form-horizontal']) !!}
                <div class="card-body">
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                       ...
                       {!! Form::select('produc_id', $p, null, ['id' => 'produc_id', 'class'=>'form-control']) !!}
                      </div>
                    </div>
                  </div>

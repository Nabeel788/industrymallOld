                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title1" id="title1"
                                            class="form-control @error('title1') is-invalid @enderror" maxlength="15" required autofocus>
                                        @error('title1')
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title2" id="title2"
                                            class="form-control @error('title2') is-invalid @enderror" maxlength="15" required>
                                        @error('title2')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="offer" id="offer"
                                            class="form-control @error('offer') is-invalid @enderror" maxlength="20" required>
                                        @error('offer')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>

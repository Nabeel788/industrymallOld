            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ asset('our-team/create') }}" class="btn btn-primary" style="float:right;"><i
                            ...
                            <tbody>
                                ...
                                @forelse ($data as $value)
                                  <tr>
                                    ...
                                    <td><img src="{{ URL::asset('root/upload/teams/small/'.$value->image) }}" alt=""></td>
                                    <td>
                                      <a href="{{ asset('our-team') }}/{{ $value->id }}/edit"><button
                                              type="button" class="btn btn-warning">Edit</button></a>
                                      <a onclick="return confirm('Are you sure you want to delete?')"
                                          href="{{ asset('our-team') }}/destroy/{{ $value->id }}"><button

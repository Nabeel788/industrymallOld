            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Return Exchange Policy</h3>&nbsp;&nbsp;&nbsp;
                        <a href="{{ asset('return-exchange-policy/create') }}" class="btn btn-primary" style="float:right;"><i
                                ...
                                <tbody>
                                    ...
                                    @forelse ($data as $value)
                                      <tr>
                                        ...
                                        <td>
                                          <a href="{{ asset('return-exchange-policy') }}/{{ $value->id }}/edit"><button
                                                  type="button" class="btn btn-warning">Edit</button></a>
                                          <a onclick="return confirm('Are you sure you want to delete?')"
                                              href="{{ asset('return-exchange-policy') }}/destroy/{{ $value->id }}"><button

                    ...
                    <form class="form-horizontal">
                        <fieldset class="fieldset">
                            ...
                            <div class="form-group avatar">
                                <figure class="figure col-md-2 col-sm-3 col-xs-12">
                                    <img class="img-rounded img-responsive"
                                        src="{{ asset('/root/upload/logo') }}/{{ $edit->logo }}" alt="">
                                </figure>
                            ...
                            <div class="form-group">
                                <label class="col-md-2 col-sm-3 col-xs-12 control-label">System Name</label>
                            ...
                            <div class="form-group">
                                <label class="col-md-2 col-sm-3 col-xs-12 control-label">Youtube</label>
                                <div class="col-md-4 col-sm-9 col-xs-12">
                            ...
                            <!----social-media-links----->
                            <div class="form-group">
                                <label class="col-md-2 col-sm-3 col-xs-12 control-label">iOS</label>
                                <div class="col-md-4 col-sm-9 col-xs-12">
                                    {!! Form::text('google_pluse', null, ['id' => 'google_pluse', 'class' => 'form-control']) !!}
                                </div>
                                <label class="col-md-2 col-sm-3 col-xs-12 control-label">Android</label>
                                <div class="col-md-4 col-sm-9 col-xs-12">
                            ...
                            <!----social-media-links----->
                            <div class="form-group">
                                <label class="col-md-2 col-sm-3 col-xs-12 control-label">Whatsapp</label>
                                <div class="col-md-4 col-sm-9 col-xs-12">
                                    {!! Form::text('whatsapp', null, ['id' => 'whatsapp', 'class' => 'form-control']) !!}
                                </div>
                                <label class="col-md-2 col-sm-3 col-xs-12 control-label">Insta</label>
                                <div class="col-md-4 col-sm-9 col-xs-12">
                        ...
                        <fieldset class="fieldset">
                            ...
                            <div class="form-group">
                                <label class="col-md-2  col-sm-3 col-xs-12 control-label">Currency</label>
                                <div class="col-md-10 col-sm-9 col-xs-12">
                            ...
                            <div class="form-group">
                                <label class="col-md-2  col-sm-3 col-xs-12 control-label">NTN</label>
                                <div class="col-md-10 col-sm-9 col-xs-12">
                                    {!! Form::text('ntn', null, ['id' => 'ntn', 'class' => 'form-control']) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2  col-sm-3 col-xs-12 control-label">STRN</label>
                                <div class="col-md-10 col-sm-9 col-xs-12">
                                    {!! Form::text('strn', null, ['id' => 'strn', 'class' => 'form-control']) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2  col-sm-3 col-xs-12 control-label">Website</label>
                                <div class="col-md-10 col-sm-9 col-xs-12">
                                    {!! Form::text('website', null, ['id' => 'website', 'class' => 'form-control']) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2  col-sm-3 col-xs-12 control-label">CEO</label>
                                <div class="col-md-10 col-sm-9 col-xs-12">
                            ...
                            <div class="form-group">
                                <label class="col-md-2  col-sm-3 col-xs-12 control-label">Cell</label>
                                <div class="col-md-10 col-sm-9 col-xs-12">
                            ...
                            <div class="form-group">
                                <label class="col-md-2  col-sm-3 col-xs-12 control-label">Google MAP</label>
                                <div class="col-md-10 col-sm-9 col-xs-12">
                                    {!! Form::text('map', null, ['id' => 'map', 'class' => 'form-control']) !!}
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2  col-sm-3 col-xs-12 control-label">Disclaimer</label>
                                <div class="col-md-10 col-sm-9 col-xs-12">
                                    {!! Form::textarea('disclaimer', null, ['id' => 'disclaimer', 'class' => 'form-control', 'rows' => 5]) !!}
                                </div>
                            </div>
                        </fieldset>
                        <hr>

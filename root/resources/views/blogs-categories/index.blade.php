            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Blogs Category Management</h3>&nbsp;&nbsp;&nbsp;
                        <a href="{{ URL::to('blogs-categories/create') }}" class="btn btn-info" style="float:right;"><i
                            ...
                            <tbody>
                                @forelse ($data as $key=>$value)
                                    <tr>
                                        ...
                                        <td>{{ $value->title }}</td>
                                        <td>
                                            <a href="{{ URL::to('blogs-categories/' . $value->id . '/edit') }}"
                                                class="btn btn-info btn-sm"><i class="fa fa-pencil"></i></a>
                                            <a onclick="return confirm('Are you sure you want to delete?')"
                                                href="{{ URL::to('blogs-categories/destroy/' . $value->id) }}"

    ...
    <div class="container">
        <div class="view-account">
            <section class="module">
                {!! Form::model($edit, [
                    'method' => 'PATCH',
                    'action' => ['App\Http\Controllers\AccountSettingController@update', $edit->id],
                ...
                <div class="content-panel">
                    ...
                    <form class="form-horizontal">
                        <fieldset class="fieldset">
                            ...
                            <div class="form-group avatar">
                                <figure class="figure col-md-2 col-sm-3 col-xs-12">
                                    @if ($edit->image != null)
                                        <img class="img-rounded img-responsive"
                                            src="{{ asset('/root/upload/users/'.$edit->image) }}"
                                            alt="" style="height: 140px; width: 140px; border: 1px solid;">
                                    @else
                                ...
                                <div class="form-inline col-md-10 col-sm-9 col-xs-12">
                                    <input type="file" id="image" name="image" class="file-uploader pull-left">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 mt-1">
                                    <label for="nation">Nation Or Business</label>
                                    {!! Form::text('nation', null, ['id' => 'nation', 'class' => 'form-control']) !!}
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-12 mt-1">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 mt-1">
                                    ...
                                    {!! Form::text('deals_in', null, ['id' => 'deals_in', 'class' => 'form-control']) !!}
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-12 mt-1">
                        ...
                        <br>
                        <input class="btn btn-primary" type="submit" id="profile" name="profile"
                        ...
                        <fieldset class="fieldset">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-9 col-xs-12">
                                    <!-- {!! Form::password('old_password', null, ['id' => 'old_password', 'class' => 'form-control']) !!} -->
                                    <input type="password" class="form-control" id="old_password" name="old_password">
                                    <p class="help-block">Current Password</p>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-9 col-xs-12">
                                    <input type="password" class="form-control" id="confirm_confirmation"
                        ...
                        <div class="form-group">
                            <div class="col-md-10 col-sm-9 col-xs-12 col-md-push-2 col-sm-push-3 col-xs-push-0">
                                <input class="btn btn-primary" type="submit" id="pswdChng" name="pswdChng"
